...
// Per-step output (step 0..7) on real CGB hardware:
//   duty 0 (12.5%): 0 0 0 0 0 0 0 1  → mask 0x80
//   duty 1 (25%):   1 0 0 0 0 0 0 1  → mask 0x81
//   duty 2 (50%):   1 0 0 0 0 1 1 1  → mask 0xE1
//   duty 3 (75%):   0 1 1 1 1 1 1 0  → mask 0x7E
// Sampled as `(mask >> step) & 1`. PCM12/PCM34 readback after specific dutyPos
// values exposes the bit pattern; mask + scan-direction together determine
// the per-step output sequence.
