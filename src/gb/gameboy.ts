...
import { STATE_VERSION, StateReader, StateWriter } from "./serialization/serialization.js";
...
export class GameBoy {
  ...
  loadState(bytes: Uint8Array): void {
    ...
    if (version !== STATE_VERSION) {
      throw new Error(`Unsupported save-state version ${version} (expected ${STATE_VERSION})`);
    }
