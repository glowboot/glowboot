...
export const translateTargetSelect = document.getElementById("translate-target-select") as HTMLSelectElement | null;
export const translateDownloadBtn = document.getElementById("translate-download") as HTMLButtonElement | null;
export const assistEndpointInput = document.getElementById("assist-endpoint") as HTMLInputElement | null;
export const assistKeyInput = document.getElementById("assist-key") as HTMLInputElement | null;
export const assistModelSelect = document.getElementById("assist-model") as HTMLSelectElement | null;
...
export const audioModeSelect = document.getElementById("audio-mode") as HTMLSelectElement | null;
...
export const touchLandscapeSelect = document.getElementById("touch-landscape-mode") as HTMLSelectElement | null;
