import { frameEl, overlayRewind, statusEl, timeEl } from "../dom.js";
...
function stepRewindLoop(): void {
  ...
  if (now - lastStepAt >= STEP_MS) {
    ...
    if (restored) {
      ...
      // otherwise "Frame" and the elapsed clock would keep ticking
      // forward while the game itself jumps backwards.
